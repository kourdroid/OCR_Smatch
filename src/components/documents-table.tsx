...
export function DocumentsTable({
  ...
  // Memoize sortedRows to prevent sorting on every render
              ...
              <TableBody>
                ...
                {paginatedRows.map((row) => {
                  if (row.type === 'group' && row.group) {
                    ...
                    // Check if any document in the group is selected
                    const isGroupSelected = row.group.documents.some((doc) => selectedDocument?.id === doc.id)
